...
int main(int argc, char **argv)
{
    ...
    std::string general_output_path = "src/robot_planning/src/libraries/sample_based_planning/test/";
    ...
    try {
        ...
        std::string image_output_dir = general_output_path + "map.png";
        ...
        // ---------------------------------------------------------
        {
            ...
            if (prm_roadmap && prm_roadmap->getNumVertices() > 0) {
                std::string output_file = general_output_path + "prm.png";
        ...
        // ---------------------------------------------------------
        {
            ...
            if (rrt) {
                std::string output_file = general_output_path + "rrt.png";
        ...
        // ---------------------------------------------------------
        {
            ...
            if (rrt_star) {
                std::string output_file = general_output_path + "rrt_star.png";
